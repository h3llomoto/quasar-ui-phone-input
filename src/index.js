...
const extendConf = function (conf) {
  ...
  conf.build.transpileDependencies.push(/quasar-app-extension-qphoneinput[\\/]src/)
  ...
  conf.css.push('~@quasar/quasar-app-extension-qzoom/src/style.scss')
  console.log(` App Extension (QPhoneInput) Info: 'Adding style.scss css reference to your quasar.conf.js'`)
}
