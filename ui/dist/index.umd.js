/*!
 * quasar-ui-quasar-phone-input v0.0.1
 * (c) 2023 h3llomoto <alexey.k.here@yandex.ru>
...
(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.qPhoneInput = factory(global.Vue, global.Quasar));
	...
	var libphonenumberExports = {};
	var libphonenumber = {
	  get exports(){ return libphonenumberExports; },
	  set exports(v){ libphonenumberExports = v; },
	};
	...
	(function (module, exports) {
		...
		*/
		...
		$jscomp.propertyToPolyfillSymbol={};$jscomp.POLYFILL_PREFIX="$jscp$";$jscomp.polyfill=function(a,b,c,d){b&&($jscomp.ISOLATE_POLYFILLS?$jscomp.polyfillIsolated(a,b,c,d):$jscomp.polyfillUnisolated(a,b,c,d));};
		...
		goog.define=function(a,b){return b};goog.FEATURESET_YEAR=2012;goog.DEBUG=!0;goog.LOCALE="en";goog.TRUSTED_SITE=!0;goog.DISALLOW_TEST_ONLY_CODE=!goog.DEBUG;goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING=!1;
		goog.provide=function(a){if(goog.isInModuleLoader_())throw Error("goog.provide cannot be used within a module.");goog.constructNamespace_(a);};goog.constructNamespace_=function(a,b,c){goog.exportPath_(a,b,c);};
		...
		goog.setCssNameMapping=function(a,b){goog.cssNameMapping_=a;goog.cssNameMappingStyle_=b;};goog.getMsg=function(a,b,c){c&&c.html&&(a=a.replace(/</g,"&lt;"));c&&c.unescapeHtmlEntities&&(a=a.replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&apos;/g,"'").replace(/&quot;/g,'"').replace(/&amp;/g,"&"));b&&(a=a.replace(/\{\$([^}]+)}/g,function(d,e){return null!=b&&e in b?b[e]:d}));return a};
		...
		goog.scope=function(a){if(goog.isInModuleLoader_())throw Error("goog.scope is not supported within a module.");a.call(goog.global);};	goog.defineClass=function(a,b){var c=b.constructor,d=b.statics;c&&c!=Object.prototype.constructor||(c=function(){throw Error("cannot instantiate an interface (no constructor defined).");});c=goog.defineClass.createSealingConstructor_(c,a);a&&goog.inherits(c,a);delete b.constructor;delete b.statics;goog.defineClass.applyProperties_(c.prototype,b);null!=d&&(d instanceof Function?d(c):goog.defineClass.applyProperties_(c,d));return c};goog.defineClass.SEAL_CLASS_INSTANCES=goog.DEBUG;
	...
	goog.TRUSTED_TYPES_POLICY_NAME="goog";goog.identity_=function(a){return a};
		...
		*/
		...
		,,[12]]],CI:[,[,,"[02]\\d{9}",,,,,,,[10]],[,,"2(?:[15]\\d{3}|7(?:2(?:0[23]|1[2357]|2[245]|3[45]|4[3-5])|3(?:06|1[69]|[2-6]7)))\\d{5}",,,,"2123456789"],[,,"0704[0-7]\\d{5}|0(?:[15]\\d\\d|7(?:0[0-37-9]|[4-9][7-9]))\\d{6}",,,,"0123456789"],[,,,,,,,,,[-1]],[,,,,,,,,,[-1]],[,,,,,,,,,[-1]],[,,,,,,,,,[-1]],[,,,,,,,,,[-1]],"CI",225,"00",,,,,,,,[[,"(\\d{2})(\\d{2})(\\d)(\\d{5})","$1 $2 $3 $4",["2"]],[,"(\\d{2})(\\d{2})(\\d{2})(\\d{4})","$1 $2 $3 $4",["0"]]],,[,,,,,,,,,[-1]],,,[,,,,,,,,,[-1]],[,,,,,,,,,[-1]],
		...
		,,"0",,,,[[,"(\\d{2})(\\d{7})","$1-$2",["[2-9]"],"0$1"]],,[,,,,,,,,,[-1]],,,[,,,,,,,,,[-1]],[,,,,,,,,,[-1]],,,[,,,,,,,,,[-1]]],MA:[,[,,"[5-8]\\d{8}",,,,,,,[9]],[,,"5(?:29(?:[189][05]|2[29]|3[01])|389[05])\\d{4}|5(?:2(?:[0-25-7]\\d|3[1-578]|4[02-46-8]|8[0235-7]|90)|3(?:[0-47]\\d|5[02-9]|6[02-8]|8[08]|9[3-9])|(?:4[067]|5[03])\\d)\\d{5}",,,,"520123456"],[,,"(?:6(?:[0-79]\\d|8[0-247-9])|7(?:[017]\\d|2[0-2]|6[0-8]))\\d{6}",,,,"650123456"],[,,"80\\d{7}",,,,"801234567"],[,,"89\\d{7}",,,,"891234567"],[,,
		,,,,,,,[-1]],[,,,,,,,,,[-1]],[,,"592(?:4[0-2]|93)\\d{4}",,,,"592401234"],"MA",212,"00","0",,,"0",,,,[[,"(\\d{5})(\\d{4})","$1-$2",["5(?:29|38)","5(?:29[89]|389)","5(?:29[89]|389)0"],"0$1"],[,"(\\d{3})(\\d{2})(\\d{2})(\\d{2})","$1 $2 $3 $4",["5[45]"],"0$1"],[,"(\\d{4})(\\d{5})","$1-$2",["5(?:2[2-489]|3[5-9]|9)|892","5(?:2(?:[2-49]|8[235-9])|3[5-9]|9)|892"],"0$1"],[,"(\\d{2})(\\d{7})","$1-$2",["8"],"0$1"],[,"(\\d{3})(\\d{6})","$1-$2",["[5-7]"],"0$1"]],,[,,,,,,,,,[-1]],1,,[,,,,,,,,,[-1]],[,,,,,,,,,[-1]],
		,,[,,,,,,,,,[-1]]],MC:[,[,,"(?:[3489]|6\\d)\\d{7}",,,,,,,[8,9]],[,,"(?:870|9[2-47-9]\\d)\\d{5}",,,,"99123456",,,[8]],[,,"4(?:[46]\\d|5[1-9])\\d{5}|(?:3|6\\d)\\d{7}",,,,"612345678"],[,,"(?:800|90\\d)\\d{5}",,,,"90123456",,,[8]],[,,,,,,,,,[-1]],[,,,,,,,,,[-1]],[,,,,,,,,,[-1]],[,,,,,,,,,[-1]],"MC",377,"00","0",,,"0",,,,[[,"(\\d{3})(\\d{3})(\\d{2})","$1 $2 $3",["87"]],[,"(\\d{2})(\\d{3})(\\d{3})","$1 $2 $3",["4"],"0$1"],[,"(\\d{2})(\\d{2})(\\d{2})(\\d{2})","$1 $2 $3 $4",["[389]"]],[,"(\\d)(\\d{2})(\\d{2})(\\d{2})(\\d{2})",
		...
		,,,"61234567",,,[8]],[,,"8(?:05[0-367]|95[0-2])\\d{4}|(?:8(?:0[1-4]|[1-8]\\d|9[0-4])|9[0-8]\\d)\\d{5}",,,,"81234567",,,[8]],[,,"(?:18|8)00\\d{7}",,,,"18001234567",,,[10,11]],[,,"1900\\d{7}",,,,"19001234567",,,[11]],[,,,,,,,,,[-1]],[,,,,,,,,,[-1]],[,,"(?:3[12]\\d|666)\\d{5}",,,,"31234567",,,[8]],"SG",65,"0[0-3]\\d",,,,,,,,[[,"(\\d{4,5})","$1",["1[013-9]|77","1(?:[013-8]|9(?:0[1-9]|[1-9]))|77"]],[,"(\\d{4})(\\d{4})","$1 $2",["[369]|8(?:0[1-5]|[1-9])"]],[,"(\\d{3})(\\d{3})(\\d{4})","$1 $2 $3",["8"]],
		...
		*/
		...
		,,,,,[-1]],[,,"893\\d\\d",,,,"89300",,,[5]],,[,,"(?:337|893\\d)\\d",,,,"3370",,,[4,5]]],AS:[,[,,"[49]\\d\\d(?:\\d{2})?",,,,,,,[3,5]],,,[,,"9(?:11|88)",,,,"911",,,[3]],[,,,,,,,,,[-1]],,,,"AS",,,,,,,,,,,,,,,,,,[,,"911",,,,"911",,,[3]],,[,,"40404|9(?:11|88)",,,,"911"],[,,,,,,,,,[-1]],[,,,,,,,,,[-1]],,[,,"404\\d\\d",,,,"40400",,,[5]]],AT:[,[,,"[168]\\d\\d(?:\\d{3})?",,,,,,,[3,6]],,,[,,"116\\d{3}|1(?:[12]2|33|44)",,,,"112"],[,,,,,,,,,[-1]],,,,"AT",,,,,,,,,,,,,,,,,,[,,"1(?:[12]2|33|44)",,,,"112",,,[3]],
		,[,,"116(?:00[06]|1(?:17|23))|(?:61|8108[1-3])0|1(?:[12]2|33|44)",,,,"112"],[,,,,,,,,,[-1]],[,,"610|810\\d{3}",,,,"610"],,[,,,,,,,,,[-1]]],AU:[,[,,"[0-27]\\d{2,7}",,,,,,,[3,4,5,6,7,8]],,,[,,"000|1(?:06|12|258885|55\\d)|733",,,,"000",,,[3,4,7]],[,,"1(?:2(?:34|456)|9\\d{4,6})",,,,"1234",,,[4,5,6,7,8]],,,,"AU",,,,,,,,,,,,,,,,,,[,,"000|1(?:06|12)",,,,"000",,,[3]],,[,,"000|1(?:06|1(?:00|2|9[46])|2(?:014[1-3]|[23]\\d|(?:4|5\\d)\\d{2,3}|68[689]|72(?:20|3\\d\\d)|8(?:[013-9]\\d|2))|555|9\\d{4,6})|225|7(?:33|67)",
		...
		,,,,,,,,,,,,,,,,,[,,"10[0-2]|[19]99",,,,"100",,,[3]],,[,,"1(?:0(?:[0-369]|5[1-4]|7[0-4]|8[0-29])|1[16-9]|2(?:[134]|2[0-5])|3(?:1\\d?|6[3-6])|5[2-9])|5012|786|9594|[19]99|1(?:0(?:50|6\\d)|33|4(?:0|1\\d))\\d",,,,"100"],[,,,,,,,,,[-1]],[,,"1(?:11|2[13])|(?:501|959)\\d|786",,,,"111",,,[3,4]],,[,,"959\\d",,,,"9590",,,[4]]],BE:[,[,,"[1-9]\\d\\d(?:\\d(?:\\d{2})?)?",,,,,,,[3,4,6]],,,[,,"1(?:0[0-35-8]|1[02]|7(?:12|77)|813)|(?:116|8)\\d{3}",,,,"100"],[,,"1(?:2[03]|40)4|(?:1(?:[24]1|3[01])|[2-79]\\d\\d)\\d",
		,,,"1204",,,[4]],,,,"BE",,,,,,,,,,,,,,,,,,[,,"1(?:0[01]|12)",,,,"100",,,[3]],,[,,"1(?:0[0-8]|1(?:[027]|6117)|2(?:12|3[0-24])|313|414|5(?:1[05]|5[15]|66|95)|6(?:1[167]|36|6[16])|7(?:[07][017]|1[27-9]|22|33|65)|81[39])|[2-9]\\d{3}|1(?:1600|45)0|1(?:[2-4]9|78)9|1[2-4]0[47]",,,,"100"],[,,,,,,,,,[-1]],[,,,,,,,,,[-1]],,[,,"[2-9]\\d{3}",,,,"2000",,,[4]]],BF:[,[,,"1\\d",,,,,,,[2]],,,[,,"1[78]",,,,"17"],[,,,,,,,,,[-1]],,,,"BF",,,,,,,,,,,,,,,,,,[,,"1[78]",,,,"17"],,[,,"1[78]",,,,"17"],[,,,,,,,,,[-1]],[,,,,
	...
	***************************************************************************** */
	...
	var all = countryInformation.map(function (item) {
	  var clonedItem = __assign({}, item);
	  if (item.languages) {
	    clonedItem.languages = __spreadArray([], item.languages, true);
	  }
	...
	var getDefault = function (country) {
	  if (country === void 0) {
	    country = 'us';
	  }
	  return all.find(function (a) {
	    return a.iso2 === country.trim().toUpperCase();
	  });
	};
	var getCountryCodeFromPhoneNumber = function (number) {
	  number = number.trim();
	  if (number.indexOf('+') === 0) {
	    number = number.slice(1);
	  }
	  return all.find(function (f) {
	    return number.indexOf(f.dialCode) === 0;
	  });
	};
	var getCountryByDialCode = function (val) {
	  if (val === void 0) {
	    val = '';
	  }
	  return all.find(function (f) {
	    return f.dialCode && val.indexOf("+".concat(f.dialCode)) !== -1;
	  });
	};
	var filterCountries = function (term) {
	  term = term.includes('+') ? term.replace('+', '') : term;
	  return all.filter(function (f) {
	    if (f.dialCode.indexOf(term) !== -1 || term.length > 2 && f.iso2LC.indexOf(term) !== -1 || f.nameLC.indexOf(term) !== -1) {
	      return true;
	    }
	    return false;
	  });
	...
	const _hoisted_1 = {
	  class: "text-no-wrap ellipsis q-ml-md"
	};
	const _hoisted_2 = {
	  class: "q-ml-sm"
	};
	...
	const _hoisted_6 = {
	  class: "v3-q-tel--country-selector last-search-item q-pa-sm"
	};
	var script$1 = /*#__PURE__*/vue.defineComponent({
	  ...
	  props: {
	    ...
	    searchInputOptions: null,
	    useIcon: {
	      type: Boolean,
	      default: false
	    }
	  },
	  emits: ["update:model-value", "country-changed"],
	  setup(__props, _ref) {
	    let {
	      emit: emits
	    } = _ref;
	    ...
	    const defaultSearchInputOptions = {
	      dense: true,
	      outlined: true,
	      filled: true,
	      label: 'Search'
	    ...
	    vue.onMounted(() => {
	      countryOptions.value = all;
	    });
	    function performSearch() {
	      const needle = searchText.value.toLowerCase().trim();
	      countryOptions.value = needle === '' ? all : filterCountries(needle);
	    }
	    ...
	    return (_ctx, _cache) => {
	      ...
	      return vue.openBlock(), vue.createBlock(vue.unref(quasar.QSelect), vue.mergeProps({
	        ...
	        "menu-offset": [12, 0],
	        "options-dense": ""
	      }, __props.dropdownOptions ?? defaultDropdownOptions, {
	        "onUpdate:modelValue": countryChanged,
	        onPopupHide: _cache[1] || (_cache[1] = $event => searchText.value = '')
	      }), vue.createSlots({
	        option: vue.withCtx(scope => [vue.createVNode(_component_q_item, vue.normalizeProps(vue.guardReactiveProps(scope.itemProps)), {
	          default: vue.withCtx(() => [vue.createVNode(_component_q_item_section, null, {
	            default: vue.withCtx(() => [vue.createVNode(_component_q_item_label, null, {
	              default: vue.withCtx(() => [vue.createElementVNode("span", {
	                class: vue.normalizeClass(!__props.useIcon ? ['v3q_tel__flag', scope.opt.iso2LC] : '')
	              }, vue.toDisplayString(__props.useIcon ? scope.opt.emoji : ''), 3), vue.createElementVNode("span", _hoisted_1, vue.toDisplayString(scope.opt.name), 1), vue.createElementVNode("span", _hoisted_2, "+" + vue.toDisplayString(scope.opt.dialCode), 1)]),
	              _: 2
	            }, 1024)]),
	            _: 2
	          }, 1024)]),
	        ...
	        "selected-item": vue.withCtx(scope => [scope.opt ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_3, [vue.createElementVNode("div", _hoisted_4, [vue.createElementVNode("span", {
	          class: vue.normalizeClass({
	            v3q_tel__flag: !__props.useIcon,
	            [scope.opt.iso2LC]: !__props.useIcon
	          })
	        }, vue.toDisplayString(__props.useIcon ? scope.opt.emoji : ''), 3), vue.createElementVNode("span", {
	          class: "ellipsis text-no-wrap q-ml-xs",
	          innerHTML: `+${scope.opt.dialCode}`
	        }, null, 8, _hoisted_5)])])) : vue.createCommentVNode("", true)]),
	        _: 2
	      }, [__props.searching ? {
	        name: "after-options",
	        fn: vue.withCtx(() => [vue.createElementVNode("div", _hoisted_6, [vue.createVNode(vue.unref(quasar.QInput), vue.mergeProps({
	          modelValue: searchText.value,
	          "onUpdate:modelValue": _cache[0] || (_cache[0] = $event => searchText.value = $event),
	          ref: "input"
	        }, __props.searchInputOptions ?? defaultSearchInputOptions, {
	          "onUpdate:modelValue": performSearch
	        }), {
	          prepend: vue.withCtx(() => [vue.createVNode(vue.unref(quasar.QIcon), {
	            name: "search"
	          })]),
	          _: 1
	        }, 16, ["modelValue"])])]),
	        key: "0"
	      } : undefined]), 1040, ["model-value", "options"]);
	    };
	  }
	});
	...
	var script = /*#__PURE__*/vue.defineComponent({
	  ...
	  props: {
	    ...
	    errorMessage: {
	      default: 'Please type coppect phone number'
	    }
	  },
	  emits: ["update:model-value", "input", "error"],
	  setup(__props, _ref) {
	    let {
	      emit: emits
	    } = _ref;
	    const props = __props;
	    const phoneNumberUtil = new libphonenumberExports.PhoneNumberUtil();
	    const country = vue.ref(getDefault(props.defaultCountry));
	    const oldCountry = vue.ref(undefined);
	    const number = vue.ref('');
	    const hasError = vue.ref(false);
	    const prevValue = vue.ref('01234567890123456789');
	    const phoneNumber = vue.ref(undefined);
	    vue.onMounted(() => {});
	    function getNumber(instance) {
	      if (!phoneNumber.value) {
	        return '';
	      }
	      let phone = phoneNumberUtil.format(instance, libphonenumberExports.PhoneNumberFormat.NATIONAL);
	    ...
	    function setPhone() {
	      ...
	      try {
	        ...
	        hasError.value = props.eagerValidate ? stringModelValue.trim() === '' ? props.required : true : false;
	        number.value = props.modelValue.toString().trim();
	      }
	      emits('error', hasError.value);
	    }
	    function phoneChanged(val) {
	      ...
	      prevValue.value = isPhoneExistsAndValid ? getNumber(phone) : prevValue.value;
	      if (num.replace(/ /g, '').length > prevValue.value.replace(/ /g, '').length) {
	        return setPhone(); // no need to update as its not valid
	      }

	      const phoneFormatted = phone ? phoneNumberUtil.format(phone, libphonenumberExports.PhoneNumberFormat.INTERNATIONAL) : val.trim();
	      emits('update:model-value', phoneFormatted);
	      emits('input', phoneFormatted);
	    }
	    function countryChanged(val, force) {
	      prevValue.value = '01234567890123456789';
	      const value = ((force ? val : (val || props.modelValue).toString()) || '').trim();
	      phoneChanged(oldCountry.value ? value.replace(`+${oldCountry.value.dialCode}`, `+${country.value.dialCode}`) : value);
	      setPhone();
	    }
	    vue.watch(() => props.modelValue, setPhone, {
	      immediate: true
	    });
	    vue.watch(() => props.defaultCountry, defaultCountry => {
	      if (defaultCountry) {
	        country.value = getDefault(defaultCountry);
	      }
	    }, {
	      immediate: true
	    });
	    vue.watch(() => country.value, () => {
	      vue.nextTick(() => {
	    ...
	    return (_ctx, _cache) => {
	      return vue.openBlock(), vue.createBlock(vue.unref(quasar.QInput), {
	        error: hasError.value,
	        "model-value": number.value,
	        class: "vue3-q-tel-input no-inherit-feedback",
	        "onUpdate:modelValue": phoneChanged,
	        maxlength: prevValue.value.length,
	        "v-bind": __props.inputOptions,
	        "error-message": __props.errorMessage
	      }, {
	        prepend: vue.withCtx(() => [vue.createVNode(script$1, {
	          modelValue: country.value,
	          "onUpdate:modelValue": _cache[0] || (_cache[0] = $event => country.value = $event),
	          "use-icon": __props.useIcon,
	          onCountryChanged: _cache[1] || (_cache[1] = $event => countryChanged()),
	          searching: __props.searching,
	          "dropdown-options": __props.dropdownOptions,
	          "search-input-options": __props.searchInputOptions,
	          class: "no-border-field-before no-padding-field font-reduced-input-adon"
	        }, null, 8, ["modelValue", "use-icon", "searching", "dropdown-options", "search-input-options"])]),
	        _: 1
	      }, 8, ["error", "model-value", "maxlength", "v-bind", "error-message"]);
	    };
	  }
	});
	...
	function install(app) {
	  app.component('QPhoneInput', script);
	}
